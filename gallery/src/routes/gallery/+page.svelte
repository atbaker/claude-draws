...
<div class="min-h-screen">
	...
	<main class="container mx-auto p-4 sm:p-8">
		...
		<!-- Filter Controls -->
		<div class="bg-kidpix-cyan border-4 border-black p-4 mb-6">
			<div class="container mx-auto flex justify-center">
				<button
					onclick={() => (showAutogenerated = !showAutogenerated)}
					class="bg-kidpix-orange text-black font-bold text-lg px-6 py-3 border-4 border-black shadow-chunky hover:shadow-chunky-hover hover:translate-x-1 hover:translate-y-1 active:translate-x-2 active:translate-y-2 active:shadow-none uppercase transition-all"
				>
